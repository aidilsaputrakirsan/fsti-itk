...
<template>
    <PublicLayout>
        ...
        <Banner title="TENAGA KEPEPENDIDIKAN" subtitle="Fakultas Sains dan Teknologi Informasi" background-image="/images/background-banner.png" />
        ...
        <div class="bg-gray-50 py-20 md:py-28 font-public-sans min-h-screen">
            <div class="container mx-auto px-6 max-w-7xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                    <div v-for="(person, index) in tendik" :key="person.id" 
