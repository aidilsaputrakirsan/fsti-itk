            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6 lg:gap-8">
                    <div v-for="(partner, index) in partners.data" :key="partner.id" class="bg-white rounded-[1rem] md:rounded-[1.5rem] border border-slate-200 shadow-sm hover:shadow-xl hover:border-primary/30 transform hover:-translate-y-1 transition-all duration-300 flex flex-col h-[300px] sm:h-[380px] md:h-[460px] group overflow-hidden" data-aos="fade-up" :data-aos-delay="(index % 10) * 50">
                        ...
                        <div class="h-28 sm:h-36 md:h-52 w-full bg-white border-b border-slate-100 p-3 sm:p-4 md:p-6 flex items-center justify-center shrink-0">
                            <img v-if="partner.logo" :src="`/storage/${partner.logo}`" :alt="partner.name" class="w-full h-full object-contain mix-blend-multiply transition-transform duration-300 group-hover:scale-105" />
                        ...
                        <div class="p-3 sm:p-4 md:p-6 flex flex-col flex-grow bg-slate-50/50 min-h-0">
                            ...
                            <h3 class="text-sm sm:text-base md:text-lg font-bold text-slate-800 group-hover:text-primary transition-colors leading-snug mb-2 md:mb-4 line-clamp-2 shrink-0">{{ partner.name }}</h3>
                            
                            <div v-if="partner.activities && partner.activities.length > 0" class="flex-grow overflow-y-auto min-h-0 pr-1 md:pr-2 space-y-2 md:space-y-3 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
