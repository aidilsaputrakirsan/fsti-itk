...
const showingFrom = computed<number>(() => props.communityServices?.from || 0);
const showingTo = computed<number>(() => props.communityServices?.to || 0);
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[900px] text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <tr v-for="(item, index) in communityServices.data" :key="item.id" class="hover:bg-slate-50/80 transition-colors duration-200 group">
