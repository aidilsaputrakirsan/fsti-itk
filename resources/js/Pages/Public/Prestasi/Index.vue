    ...
    <PublicLayout>
        ...
        <div class="bg-white font-public-sans pb-24">
            ...
            <section class="max-w-[95%] xl:max-w-[100rem] mx-auto px-4 xl:px-8 mb-24 min-h-[400px]">
                ...
                <div v-if="search || selectedCategory || selectedLevel || selectedYear" class="mb-8 bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4" data-aos="fade-up">
