...
>                        <Search class="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-primary/60" />
                ...
                <div v-else>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-4 md:mx-8">
                    ...
                    <div class="relative z-20" data-aos="fade-in">
                        <PublicPagination :meta="announcements" />
                    </div>
                </div>
