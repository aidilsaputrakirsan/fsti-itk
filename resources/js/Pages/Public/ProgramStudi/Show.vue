...
<template>
    <PublicLayout>
        ...
        <section v-if="prodi.vision" class="bg-white pb-16 font-public-sans">
        ...
        <section v-if="prodi.mission && prodi.mission.length > 0" class="bg-primary/5 py-20 md:py-24 border-y border-primary/10 font-public-sans">
            <div class="container mx-auto px-6 lg:px-8 max-w-6xl">
                <div class="grid lg:grid-cols-12 gap-10 items-start">
                    ...
                    <div class="lg:col-span-8 flex flex-col space-y-6 relative">
                        <div v-for="(misi, index) in prodi.mission" :key="index" class="flex items-start gap-6 bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-primary/10 hover:border-primary/40 transition-all" data-aos="fade-left" :data-aos-delay="index * 50">
        ...
        <section v-if="prodi.goals" class="bg-white py-20 md:py-24 font-public-sans">
            <div class="container mx-auto px-6 lg:px-8 max-w-5xl">
                <div class="bg-primary/5 rounded-3xl p-8 md:p-12 shadow-sm border border-primary/10" data-aos="fade-up">
        ...
        <section v-if="prodi.graduate_profiles && prodi.graduate_profiles.length > 0" class="bg-primary/5 py-20 font-public-sans border-y border-primary/10">
            <div class="container mx-auto px-6 lg:px-8 text-center">
                <div class="text-center mb-14" data-aos="fade-up">
                    ...
                    <p class="text-gray-600 font-medium">Peluang karier unggulan bagi lulusan {{ prodi.name }}.</p>
                </div>
        ...
        <section v-if="prodi.accreditation_text || prodi.accreditation_certificate_image" class="bg-white py-24 font-public-sans">
            <div class="container mx-auto px-6 lg:px-8 max-w-6xl">
                <div class="bg-primary rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row relative" data-aos="fade-up">
                    ...
                    <div class="p-10 md:p-14 flex flex-col text-white z-10 transition-all duration-500"
                         :class="prodi.accreditation_certificate_image ? 'md:w-1/2 justify-center' : 'w-full items-center text-center'">
                        ...
                        <p class="text-blue-50 leading-relaxed mb-10 text-lg font-medium" 
                           :class="!prodi.accreditation_certificate_image ? 'max-w-2xl mx-auto' : ''">
                            {{ prodi.accreditation_text }}
                        </p>
                        
                        <div v-if="prodi.accreditation_pdf_link" class="mt-auto">
                            <a :href="prodi.accreditation_pdf_link" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 py-3.5 px-6 bg-white text-primary hover:bg-gray-100 font-bold rounded-xl shadow-sm transition-colors w-max">
                                Unduh Sertifikat Resmi (PDF) <FileDown class="w-5 h-5" />
                            </a>
                        </div>
                    </div>

                    <div v-if="prodi.accreditation_certificate_image" class="md:w-1/2 bg-white relative min-h-[350px] flex items-center justify-center p-8 border-l-8 border-primary/20">
                        <img 
        ...
        <section v-if="prodi.website_link" class="bg-white py-20 pb-28 font-public-sans border-t border-gray-100">
            <div class="container mx-auto px-6 lg:px-8 text-center" data-aos="fade-up">
                ...
                <p class="text-gray-600 font-medium text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                    Kunjungi website resmi Program Studi {{ prodi.name }} untuk informasi detail mengenai kurikulum, kegiatan mahasiswa, hingga pendaftaran.
                </p>
                <a :href="prodi.website_link" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-3 bg-primary text-white font-bold py-4 px-8 rounded-xl shadow-lg hover:bg-opacity-90 hover:shadow-xl transition-all hover:-translate-y-1">
