...
const fileNameDisplay = computed(() => {
    ...
    return 'Pilih file gambar (Maks. 2 MB)';
});
...
<template>
    <div>
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Tambah Berita</h1>
            <p class="mt-1 text-gray-600">Buat berita baru untuk website FSTI ITK.</p>
        </div>
            ...
            <form @submit.prevent novalidate>
                <div class="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-x-8 gap-y-6 md:gap-y-8">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-[11px] text-gray-500 font-medium">Format yang didukung: JPG, PNG, WEBP. Ukuran maksimal 2 MB.</p>
    ...
    <Teleport to="body">
        <div v-if="showLinkModal" class="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm transition-opacity">
