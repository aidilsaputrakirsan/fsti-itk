...
<template>
    <div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <Link :href="route('admin.agenda-fakultas.create')" class="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-primary-hover transition-colors flex-shrink-0">
                        ...
                        <tr v-if="agendas.data && agendas.data.length > 0" v-for="item in agendas.data" :key="item.id">
                            ...
                            <td>
                                <div class="flex items-center justify-center gap-3">
                                    <Link :href="route('admin.agenda-fakultas.edit', item.id)" class="flex items-center gap-1 text-primary hover:text-primary-hover font-semibold transition-colors">
