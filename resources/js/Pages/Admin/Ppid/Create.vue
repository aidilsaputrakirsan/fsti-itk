...
<template>
    <div>
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-black">Tambah Dokumen PPID</h1>
            <p class="mt-1 text-black">Buat dokumen PPID baru</p>
        </div>
        ...
        <div class="bg-white shadow-sm p-8 rounded-lg">
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-black mb-2">Upload File (PDF/DOC)</label>
                    <input 
