...
<template>
    <div>
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-black">Tambah Data Alumni</h1>
            <p class="mt-1 text-black">Masukkan data kelulusan mahasiswa baru Fakultas Sains dan Teknologi Institut Teknologi Kalimantan</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" id="nim" v-model="form.nim" placeholder="Contoh: 02161001" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#4682A9] focus:ring-[#4682A9] focus:ring-opacity-50 sm:text-sm" required />
                        ...
                        <div>
                            ...
                            <input type="text" id="name" v-model="form.name" placeholder="Masukkan nama lengkap alumni" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#4682A9] focus:ring-[#4682A9] focus:ring-opacity-50 sm:text-sm" required />
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="graduation_year" v-model="form.graduation_year" min="2000" :max="new Date().getFullYear() + 1" placeholder="Contoh: 2024" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#4682A9] focus:ring-[#4682A9] focus:ring-opacity-50 sm:text-sm" required />
