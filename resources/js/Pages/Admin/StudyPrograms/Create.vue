        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <textarea id="description" v-model="form.description" rows="5" placeholder="Masukkan 1-2 paragraf deskripsi singkat tentang prodi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#4682A9] focus:ring-[#4682A9] focus:ring-opacity-50 sm:text-sm" />
          ...
          <div class="space-y-6">
            <div>
              <label for="mission" class="block text-sm font-semibold text-black">Misi <span class="text-xs font-normal text-[#4682A9]">(Gunakan 'Enter' untuk memisah poin)</span></label>
              <textarea id="mission" v-model="form.mission" rows="5" placeholder="1. Misi pertama...&#10;2. Misi kedua..." class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#4682A9] focus:ring-[#4682A9] focus:ring-opacity-50 sm:text-sm" />
            </div>

            <div>
              <label for="graduate_profiles" class="block text-sm font-semibold text-black">Profil Lulusan / Karier <span class="text-xs font-normal text-[#4682A9]">(Gunakan 'Enter' untuk memisah poin)</span></label>
              <textarea id="graduate_profiles" v-model="form.graduate_profiles" rows="5" placeholder="Data Analyst&#10;Aktuaris&#10;Konsultan" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#4682A9] focus:ring-[#4682A9] focus:ring-opacity-50 sm:text-sm" />
            </div>
            ...
            <div>
              ...
              <textarea id="accreditation_text" v-model="form.accreditation_text" rows="2" placeholder="Telah terakreditasi oleh BAN-PT dengan peringkat Baik." class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#4682A9] focus:ring-[#4682A9] focus:ring-opacity-50 sm:text-sm" />
            </div>
          ...
          <div class="md:col-span-2 border-t pt-6">
            ...
            <div class="mt-1 relative flex items-center w-full rounded-md border border-gray-300 bg-gray-50 shadow-sm px-4 py-3 hover:bg-gray-100 transition">
              ...
              <input type="file" id="image" @input="form.accreditation_certificate_image = $event.target.files[0]" accept="image/*" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
            </div>
