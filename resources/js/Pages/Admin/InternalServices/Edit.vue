...
const submit = () => {
    form.put(route('admin.internal-services.update', props.service.id));
};
</script>
...
<template>
    <div>
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-black">Edit Layanan Internal</h1>
        </div>
        ...
        <div class="bg-white shadow-sm p-8 rounded-lg">
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div>
                    ...
                    <input v-model="form.link_url" type="url" required class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" />
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="form.category" type="text" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" />
                    </div>
                    <div>
