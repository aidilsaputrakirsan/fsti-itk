...
<template>
    <div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <Link :href="route('admin.zi.document.create')" class="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-primary-hover transition-colors flex-shrink-0">
                        ...
                        <tr v-if="documents.data && documents.data.length > 0" v-for="(item, index) in documents.data" :key="item.id">
                            ...
                            <td>
                                <div class="flex items-center justify-center gap-3">
                                    <Link :href="route('admin.zi.document.edit', item.id)" class="flex items-center gap-1 text-primary hover:text-primary-hover font-semibold transition-colors">
