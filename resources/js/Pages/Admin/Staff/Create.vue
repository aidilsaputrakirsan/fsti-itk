...
const showJabatan = computed(() => form.category && form.category !== 'Dosen' && form.category !== 'Tenaga Kependidikan'); // Simplified logic, allow jabatan for leaders
...
<template>
    <div>
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-black">Tambah Civitas Baru</h1>
        </div>
        ...
        <div class="bg-white shadow-sm p-8 rounded-lg max-w-4xl">
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <!-- Upload Foto -->
                <div>
                     <label class="block text-sm font-semibold text-black mb-2">Foto Profil</label>
                    <input 
                        type="file" 
