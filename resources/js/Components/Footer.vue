...
<template>
    <footer class="relative font-inter text-white">
        <div class="absolute bottom-0 left-0 w-full h-[95%] bg-[#2F4DD3] rounded-t-[100px] md:rounded-t-[200px]"></div>

        <div 
            class="absolute top-0 left-0 w-full h-24 md:h-32" 
            style="clip-path: ellipse(80% 100% at 50% 100%);">
        </div>

        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-7xl mx-auto bg-white rounded-full md:rounded-full py-4 px-6 md:px-8 md:py-5 flex flex-col md:flex-row items-center justify-between text-center md:text-left mb-8 md:mb-12 shadow-lg border-2 border-[#2F4DD3]">
                <div>
                    <h2 class="font-kulim-park text-lg md:text-2xl font-bold text-[#2F4DD3]">Terhubung dengan FSTI ITK</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-x-4 gap-y-10 lg:gap-8 ml-0 lg:ml-20 py-1 pb-10 md:pb-12 text-white border-b border-white/20">
                ...
                <div class="space-y-3 md:space-y-4">
                    <div class="flex items-center space-x-3">
                         ...
                         <div>
                            ...
                            <p class="text-[10px] md:text-sm text-gray-200">Institut Teknologi Kalimantan</p>
                         </div>
                    </div>
                    <p class="text-[11px] md:text-sm text-gray-100">Membentuk talenta digital inovatif dan berdaya saing global untuk memajukan Kalimantan dan Indonesia.</p>
                </div>

                <div class="space-y-3 lg:space-y-4 lg:ml-5">
                    <h3 class="text-xs md:text-base font-bold">Informasi Kontak</h3>
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-1 gap-4 lg:gap-4 text-[10px] md:text-sm">
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start gap-1.5 md:gap-3 list-none">
                                ...
                                <div>
                                    <p class="font-semibold mb-0.5">Alamat</p>
                                    <p class="whitespace-pre-line text-gray-200">{{ contact.address || 'Kampus ITK, Jl. Soekarno Hatta KM 15, Balikpapan' }}</p>
                                </div>
                            </li>
                            <li class="flex items-start gap-1.5 md:gap-3 list-none">
                                <div class="mt-0.5 flex-shrink-0"><svg class="h-3.5 w-3.5 md:h-5 md:w-5 text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg></div>
                                <div class="w-full">
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start gap-1.5 md:gap-3 list-none">
                                ...
                                <div>
                                    <p class="font-semibold mb-0.5">Jam Operasional</p>
                                    <p class="whitespace-pre-line text-gray-200">{{ contact.operating_hours || "Senin - Jumat, 07.30 - 16.00 WITA" }}</p>                            
                                </div>
                            </li>
                            <li class="flex items-start gap-1.5 md:gap-3 list-none">
                                <div class="mt-0.5 flex-shrink-0">
                                    <svg class="h-3.5 w-3.5 md:h-5 md:w-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                                </div>
                                <div class="w-full">
                                    <p class="font-semibold mb-0.5">WA Layanan</p>
                                    <div class="flex flex-col gap-0.5">
                                        <a href="https://wa.me/6285172302157" target="_blank" rel="noopener noreferrer" class="text-gray-200 hover:text-white transition-colors break-words">Akademik: +62 851-7230-2157</a>
                                        <a href="https://wa.me/6285172312157" target="_blank" rel="noopener noreferrer" class="text-gray-200 hover:text-white transition-colors break-words">Keuangan: +62 851-7231-2157</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="space-y-3 lg:space-y-4">
                    <h3 class="text-xs md:text-base font-bold">Tautan Penting</h3>
                    <ul class="flex flex-row lg:flex-col flex-wrap gap-x-6 gap-y-2 lg:gap-y-3 text-[10px] md:text-sm">
                        <li><a href="https://itk.ac.id/" target="_blank" rel="noopener noreferrer" class="text-gray-200 hover:text-white transition-colors">Website Utama ITK</a></li>
                        <li><a href="https://pmb.itk.ac.id/" target="_blank" rel="noopener noreferrer" class="text-gray-200 hover:text-white transition-colors">PMB ITK</a></li>
                    </ul>
                </div>
            </div>

            <div class="max-w-7xl mx-auto w-full py-6 md:py-8 flex flex-col md:flex-row justify-between items-center gap-5 text-white/80">
                <div class="text-[9px] md:text-xs tracking-wider text-center md:text-left">
                ...
                <div class="flex flex-col items-center gap-1.5 md:gap-2">
                    ...
                    <div class="flex items-center gap-4 md:gap-6 bg-white/10 backdrop-blur-md px-4 md:px-6 py-2.5 md:py-3 rounded-2xl border border-white/20 shadow-xl w-max">
                        ...
                        <div class="w-px h-5 md:h-6 bg-white/20"></div>
                        <div class="flex flex-col items-center justify-center gap-1">
        ...
        >
            <button v-if="showScrollTop" @click="scrollToTop" class="fixed bottom-6 right-6 bg-white text-[#2F4DD3] p-2 md:p-3 rounded-full shadow-lg border border-gray-200 hover:bg-gray-100 focus:outline-none z-50">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:h-6 md:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" /></svg>
            </button>
        </transition>
    </footer>
</template>